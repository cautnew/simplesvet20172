...
--
-- Create database "selecao_phpdev2017_2"
--
CREATE DATABASE selecao_phpdev2017_2
  CHARACTER SET utf8
...
--
-- Create user "selecao_phpdev"
--
CREATE USER 'selecao_phpdev'@'localhost';
GRANT ALL PRIVILEGES ON *.* TO 'selecao_phpdev'@'localhost'
WITH GRANT OPTION;
SET PASSWORD FOR 'selecao_phpdev'@'localhost' = PASSWORD ('barcelona');
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TEMPORARY TABLES, CREATE VIEW, DROP, EVENT, EXECUTE, GRANT OPTION, INDEX, LOCK TABLES, REFERENCES, SHOW VIEW, TRIGGER ON selecao_phpdev2017_2.* TO 'selecao_phpdev'@'localhost';